...
# Instead of printing the whole HTML content, print only the first 1000 characters as a preview
print(str(soup)[:1000])  
# Prints a preview of the parsed HTML content to check the page structure without overwhelming output
